   ...
   //文保详情
    ...
    $(function(){
        ...
        var scrollLoad = app.scrollLoad({
            url:urlPaths.presCultural.content,
            param:{p:"v",id:value},
            content:"#newsdetail",
            tpl:"tpl",
            ...
            cb:function(resData, textStatus,jqXHR){
                ...
                var config = {
                    ...
                    img:resData.data.top_pic || "http://192.168.11.226:8081/themes/simplebootx/Public/images/img_logo.png",
                ...
                window._bd_share_config = {
                    common : {
                        ...
                        bdUrl : location.href,
                        bdPic : resData.data.top_pic || "http://192.168.11.226:8081/themes/simplebootx/Public/images/img_logo.png"
                    },
                    share : [{
        ...
        var scrollLoad_comment = app.scrollLoad({
            ...
            param:{p:"v",type:"3",pernum:"3",id:value},
            content:"#comment",
            tpl:"tpl_comment",
            cb:function(resData, textStatus,jqXHR){
                console.log("回调成功");
                ...
                $(".btn-reply").click(function(){
                    if($(this).html()=="回复"){
                        ...
                        $(".comment-submit2").click(function(){
                            ...
                            if($("#token").val()!=""){
                                $.post(CONFIG.ajaxApiUrlRoot+"Comment/send",{ p:"v",token:token,pid:reid,type:"3",title:tit,content:recon,id:value},function(data){
                                    if(data.status=='1'){
                                        alert(data.msg);
                ...
                $(".comment-submit1").click(function(){
                    ...
                    tit=$(".newsdetail-title").html();
                    if($("#token").val()!=""){
                        $.post(CONFIG.ajaxApiUrlRoot+"Comment/send",{ p:"v",token:token,pid:"0",type:"3",title:tit,content:con,id:value},function(data){
                            if(data.status=='1'){
                                alert(data.msg);
                                $(".comment-textarea").val("");
                            }else{
        ...
        $(".comment-all").click(function(){
            location.href=U("portal/index/comment",{type:3,id:value});
        });
